...
# Proporciones por fila (maint)
prop_tab <- prop.table(table(car$maint, car$buying), margin = 1)
...
barplot(
  ...
  col = c("red", "orange", "lightgreen", "darkgreen"),
  legend = TRUE,
  main = "Maintenance Cost vs Buying Price (Proportions)",
  xlab = "Maintenance Cost",
  ylab = "Proportion",
  ylim = c(0, 1)
)
